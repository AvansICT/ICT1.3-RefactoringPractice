...
De volgende C# code gebruikt een string-veld om het telefoonnummer van een klant op te slaan. 
Refactor de code om de telefoonnummer string property te vervangen door een `PhoneNumber` object.
